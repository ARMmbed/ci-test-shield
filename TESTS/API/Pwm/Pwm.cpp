...
void PWM_Duty_slave(PinName pwm_out_pin, PinName int_in_pin, int period_in_ms, float duty_cycle_percent)
{
    ...
    printf("\r\n*****\r\n period = %fs, duty cycle = %f \r\n***",(float)period_in_ms / 1000, duty_cycle_percent);
    ...
    printf("\r\n***\r\n rise_count = %d, fall count = %d, TotalTime = %d, avgTime = %f, expected time = %f \r\n***",duty_rise_count,duty_fall_count,duty_running_count,avgTime, expectedTime);
